...
\abstract{
The unknown composition of cosmic dark matter is one of the greatest mysteries of science. In addition to direct and indirect searches, dark matter may be measured after its production in high energy particle colliders. The study presented here is a search for dark matter produced by 13 TeV proton-proton collisions at the Large Hadron Collider (LHC) using the Compact Muon Solenoid (CMS) detector. Dark matter escapes the detector undetected, resulting in a large imbalance of transverse momentum, which can be observed when a Standard Model particle is tagged opposite, in this case, the Higgs. The discovery of the Higgs boson opens a new portal to the search for dark matter, with a variety of models motivated by a dark matter and Higgs interaction, whose signatures are called Mono-Higgs. Results are shown for the mono-Higgs search in two Higgs decay channels and for the baseline Higgs search with a third channel.
}
